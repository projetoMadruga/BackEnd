...
import Ouvidoria.Senai.dtos.TokenJWTDTO;
import Ouvidoria.Senai.dtos.RefreshTokenDTO;
...
public class LoginController {
    ...
    @GetMapping("/usuarios")
    public ResponseEntity<List<LoginDTO>> listarUsuarios() {
        try {
            List<LoginDTO> usuarios = loginService.listarTodosUsuarios();
